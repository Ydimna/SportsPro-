...
namespace SportsPro.Data.Migrations
{
    ...
    [Migration("20210520150732_SportsPro")]
    partial class SportsPro
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportsPro.Domain.Authentication", b =>
                {
            ...
            modelBuilder.Entity("SportsPro.Domain.Country", b =>
                {
            ...
            modelBuilder.Entity("SportsPro.Domain.Customer", b =>
                {
            ...
            modelBuilder.Entity("SportsPro.Domain.Incident", b =>
                {
            ...
            modelBuilder.Entity("SportsPro.Domain.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SportsPro.Domain.Registration", b =>
                {
            ...
            modelBuilder.Entity("SportsPro.Domain.Technician", b =>
                {
                    b.Property<int>("TechnicianID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SportsPro.Domain.Customer", b =>
                {
                    b.HasOne("SportsPro.Domain.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("SportsPro.Domain.Incident", b =>
                {
                    b.HasOne("SportsPro.Domain.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportsPro.Domain.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportsPro.Domain.Technician", "Technician")
                        .WithMany()
